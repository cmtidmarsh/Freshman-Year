...
def main():
#------------Creating Window--------------
    display = width, height = 700, 500
    screen = pygame.display.set_mode((display))
    caption = pygame.display.set_caption("Pride Month Maze")
...
#-----------Drawing Objects to avoid---------------
    ...
    # pygame.draw.line(screen, (BLACK),(50,300),(100,300), 2)
    # pygame.draw.line(screen, (BLACK),(400,300),(450,300), 2)
    # pygame.draw.line(screen, (BLACK),(550,300),(500,300), 2)
    # pygame.draw.line(screen, (BLACK),(700,300),(650,300), 2)
    # pygame.draw.line(screen, (BLACK),(200,300),(240,300), 2) 
