...
def startMenu():
    ...
    text = font1.render("Instructions", True, rn.choice(colorChoices))
    screen.blit(text, (160, 435))

    font2 = pg.font.SysFont(None, 100)
    textstart = font2.render("Start", True, rn.choice(colorChoices))
    ...
    score = font4.render("Scores", True, rn.choice(colorChoices))
